...
quark_masses = pd.DataFrame([
    ...
    ###########
    # 1/5 ms
    [0.03, '1/5', 0.6084, '1.0 m_b'],
    [0.03, '1/5', 0.53164, '4.0 m_charm'],
    [0.03, '1/5', 0.3987, '3.0 m_charm'],
    [0.03, '1/5', 0.1329, '1.0 m_charm'],
    [0.03, '1/5', 0.1196, '0.9 m_charm'],
    [0.03, '1/5', 0.01129, '1.0 m_strange'],
    [0.03, '1/5', 0.002258, '0.2 m_strange'],
    ],

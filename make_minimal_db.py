...
def main():
    ...
    id SERIAL PRIMARY KEY
    ens_id       integer REFERENCES correlation_function (ens_id),
    ...
    ens_id    integer REFERENCES result_two_point (ens_id), 
    corr_id   integer REFERENCES result_two_point (corr_id),
    UNIQUE(ens_id, corr_id);
    """

    systematic_two_point = """
    id SERIAL PRIMARY KEY,
    ens_id  integer REFERENCES campaign_two_point (ens_id)
    corr_id integer REFERENCES campatin_two_point (corr_id)
